...
# 🔴 ستاسو د نوي بوټ ټوکن او د لینک تنظیمات
BOT_TOKEN = "8604114942:AAH5u6SD80a7WIHZmlb2wfe0edzQSUyaf30"
BOT_LINK = "https://t.me/AlldownloadkarimiBot"
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text(
        ...
        f"زما په ربات (@AlldownloadkarimiBot) کې ښه راغلاست.\n"
        f"مهرباني وکړئ د ویډیو یا غږ (TikTok, Instagram, YouTube) لینک راولیږئ ترڅو په لوړ کیفیت کې یې درته ډانلوډ کړم. ⚡"
    )
...
async def handle_link(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        with yt_dlp.YoutubeDL(ydl_opts) as ydl:
            ...
            caption_text = f"📌 {title}\n\n⏱ زمان: {duration_minutes} دقیقه\n\n👇 کوم کیفیت ډانلوډول غواړئ؟ کلیک پرې کړئ:"
